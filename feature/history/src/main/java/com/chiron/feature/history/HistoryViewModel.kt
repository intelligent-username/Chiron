...
import com.chiron.core.model.SequenceType
...
data class HistoryUiState(
    ...
    val distanceUnit: com.chiron.core.common.DistanceUnit = com.chiron.core.common.DistanceUnit.METERS
)
...
class HistoryViewModel(
    ...
    suspend fun getExerciseById(exerciseId: Long): com.chiron.core.model.Exercise? = repository.getExerciseById(exerciseId)
    suspend fun getAllExercises(): List<com.chiron.core.model.Exercise> = repository.getAllExercises()
